...
def get_random_nickname(message, case, cmd=None):
    ...
    if message.guild and message.guild.id == 318733700160290826:
        nicks = nicks_default + nicks_mpf
    elif message.guild and message.guild.id == 174449535811190785:
...
nicks_politbiuro = [
 ...
 #   ["Holy.Death", "Holiego", "Holiemu", "Holiego", "Holim", "Holim", "Holy", ""],
    ...
    ["Komstuch", "Komstucha", "Komstuchowi", "Komstucha", "Komstuchem", "Komstuchu", "Komstuchu", ""],
    ...
    ["Martius", "Martiusa", "Martiusowi", "Martiusa", "Martiusem", "Martiusie", "Martiusie", " <:martius:293023123870187520>"],
